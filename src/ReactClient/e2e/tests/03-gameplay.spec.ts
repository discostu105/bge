...
test.describe('Create player', () => {
	test('create player page renders and form is functional', async ({ browser }) => {
		...
		// Use page.goto with a data: URL form to POST signindev, which sets the auth cookie
		// directly in the browser (page.request.post doesn't share cookies with page navigation).
